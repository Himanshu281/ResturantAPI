...
namespace ResturantAPI.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public async Task<ActionResult<OrderMaster>> PostOrderMaster(OrderMaster orderMaster)
        {
            ...
            return CreatedAtAction("GetOrderMaster", new { id = orderMaster.MyProperty }, orderMaster);
        }
        ...
        {
            return _context.OrderMasters.Any(e => e.MyProperty == id);
        }
    }
}
